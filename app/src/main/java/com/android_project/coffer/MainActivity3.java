...
public class MainActivity3 extends AppCompatActivity {
    ...
    public void GenerateGrid(int[] password_img_array)
    {
        ...
        image_button_array[random_button_idx].setImageResource(password_img_array[random_password_image_idx]);
        ...
        for (i=0; i < 9; i++)
        {
            if(i != random_button_idx)
            {
                ...
                image_button_array[i].setImageResource(img_all_multi[random_category_idx][random_image_idx]);
